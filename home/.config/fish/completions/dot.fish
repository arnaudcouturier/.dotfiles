...
complete -c dot -n __fish_use_subcommand -a arch-setup -d 'Provision this Arch machine (Arch-only)'
complete -c dot -n __fish_use_subcommand -a arch-check -d 'Verify Arch provisioning (Arch-only)'
complete -c dot -n __fish_use_subcommand -a fedora-setup -d 'Provision this Fedora machine (Fedora-only)'
complete -c dot -n __fish_use_subcommand -a fedora-check -d 'Verify Fedora provisioning (Fedora-only)'
...
complete -c dot -n '__fish_seen_subcommand_from arch-setup' -l only -r -d 'Comma-separated provisioning steps'
